  ...
  return (
      <header className="w-full h-[80px] bg-[var(--background-header)] flex items-center text-white justify-between px-9">
        ...
        <div className='items-center inline-flex gap-[40px]'>
          <button className='font-black hover:text-[#62CAFF] transition-colors duration-300 cursor-pointer'>INICIO</button> 
          <button className='font-black hover:text-[#62CAFF] transition-colors duration-300 cursor-pointer'>CHAT</button> 
          <button className='font-black hover:text-[#62CAFF] transition-colors duration-300 cursor-pointer'>MAPAS</button> 
          <button className='font-black hover:text-[#62CAFF] transition-colors duration-300 cursor-pointer'>SOBRE</button> 
        </div>
        <a href="#">
